...
-- Purpose: KPI queries and analysis objects for free-shipping validation
-- Compatible with raw/marts/analytics layered schemas
...
-- Q2. Count orders with freight = 0 by month
SELECT
    order_month,
...
-- Q3. Identify seller-months with campaign-like free-shipping behavior
SELECT
    seller_id,
    order_month,
    orders,
...
-- Q4. Segment comparison: campaign-like seller-months vs others
...
-- Q5. Review score lift: free-shipping vs paid-shipping orders
SELECT
...
-- Q6. Correlation helper view for Python
...
SELECT * FROM analytics.v_monthly_corr_input ORDER BY order_month;

-- Q7. Hong Kong-ready policy simulation
